...
def create_app():
    ...
    def stats():
        ...
        pace_dist = get_pace_distribution(db, date_from, date_to)
    ...
    def generate_report():
        ...
        pace_distribution = get_pace_distribution(db, date_from, date_to)
        db.close()
        ...
        training_data['pace_distribution'] = pace_distribution
