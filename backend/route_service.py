...
class RouteService:
    ...
    def _detect_city(self, lat, lng):
        """Simple city detection based on coordinates."""
        # Major cities with approximate bounding boxes
        cities = [
            # China
            ...
            # UAE
            ('迪拜', 25.0, 25.4, 55.0, 55.6),
            ('阿布扎比', 24.3, 24.7, 54.3, 54.9),
            ('沙迦', 25.2, 25.5, 55.2, 55.6),
            # International
            ('东京', 35.5, 35.9, 139.5, 139.9),
            ('首尔', 37.4, 37.7, 126.8, 127.2),
            ('新加坡', 1.2, 1.5, 103.6, 104.1),
            ('曼谷', 13.5, 14.0, 100.3, 100.8),
            ('悉尼', -34.1, -33.6, 151.0, 151.4),
            ('墨尔本', -38.0, -37.6, 144.7, 145.2),
            ('伦敦', 51.3, 51.7, -0.3, 0.1),
            ('巴黎', 48.7, 49.0, 2.2, 2.6),
            ('纽约', 40.5, 40.9, -74.1, -73.7),
            ('洛杉矶', 33.8, 34.3, -118.5, -118.0),
            ('旧金山', 37.6, 37.9, -122.6, -122.2),
        ]
